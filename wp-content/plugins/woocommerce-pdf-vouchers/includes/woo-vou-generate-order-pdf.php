...
$common_product_id = $vou_product_id;

//get product item quantity
$quantity		= !empty( $voucodes ) ? count( explode( ',', $voucodes ) ) : 0;
if( !empty( $product_var_id ) ){
	$common_product_id = $product_var_id;
}
$quantity = !empty( $woo_product_details[$common_product_id]['product_quantity'] ) ? $woo_product_details[$common_product_id]['product_quantity'] : $quantity;
