...
class WOO_Vou_Public {
    ...
    */
    ...
    /**
     * Handle to create dummy product download link to avoid invalid download link bug with WooCommerce 6.5
     *
     * @package WooCommerce - PDF Vouchers
     * @since 4.2.1
     */
    public function woo_vou_set_dummy_product_download( $downloads, $obj ) {
    ...
    public function add_hooks() {
       ...
       // Filter to hide download link from the checkout and thank you page
        ...
        add_filter('woocommerce_product_get_downloads',array($this,'woo_vou_set_dummy_product_download'),10,2);

         add_filter('woocommerce_product_variation_get_downloads',array($this,'woo_vou_set_dummy_product_download'),10,2);
    }
}
